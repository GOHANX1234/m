...
private val DarkColorScheme = darkColorScheme(
    ...
    surfaceVariant = MAGlass,
    onSurfaceVariant = MATextSecondary,
    surfaceDim = MADark,
    surfaceBright = MAGlassHigh,
    surfaceContainerLowest = MADark,
    surfaceContainerLow = MAGlassLow,
    surfaceContainer = MAGlass,
    surfaceContainerHigh = MACard,
    surfaceContainerHighest = MACardElevated,
